...
export default function MovingCalculator({
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#E2EEFD] rounded-2xl lg:rounded-full p-3 flex flex-col lg:flex-row gap-4 items-stretch lg:items-center">
        {/* Moving From */}
        <div className="flex-1 bg-white rounded-xl lg:rounded-full px-4 md:px-6 py-3">
        ...
        {/* Button */}
        <button
          className="bg-[#116087] text-white text-[14px] font-light cursor-pointer px-6 py-3 rounded-full border border-transparent hover:bg-white hover:text-black hover:border-[#116087] transition-all duration-300 w-full lg:w-auto"
        >
          Calculate Cost Now
        </button>
      </div>
